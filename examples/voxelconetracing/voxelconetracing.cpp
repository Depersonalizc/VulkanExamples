...
public:
	...
	VkPipelineLayout pipelineLayout;  // In VulkanApp Material::pipelineLayout
	struct {
		VkDescriptorSet model;
		VkDescriptorSet background;
		VkDescriptorSet shadow;
	} descriptorSets;                 // In VulkanApp Material::descriptorSet
	...
	void draw()  // helper for render(), submitting to cmd queue
	{
		VulkanExampleBase::prepareFrame();  // acquire the next swapchain image
		{
			...
			// Scene rendering (VulkanExampleBase::renderFrame)
