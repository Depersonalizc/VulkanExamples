...
void CameraActor::setCamera(glm::vec3 eyePositionParam, glm::vec3 lookVectorParam, glm::vec3 upVectorParam, float fovYParam, float width, float height, float nearParam, float farParam)
{
...
void CameraActor::UpdateAspectRatio(float aspectRatioParam)
{
...
void CameraActor::UpdateOrbit(float deltaX, float deltaY, float deltaZ)
{
...
void CameraActor::UpdatePosition(float deltaX, float deltaY, float deltaZ)
{
...
#if FEATURE_OVR
void CameraActor::UpdateMatricesHmdVR(const glm::vec3& relativeLeftPos, const glm::vec3& relativeRightPos) {
	viewMat = glm::inverse(modelMat);
	lookVector = glm::vec3(viewMat[2].x, viewMat[2].y, viewMat[2].z);
...
void CameraActor::UpdateOrbitHmdVR(const glm::vec3& deltaHmdEuler, const glm::vec3& deltaHmdPos, const glm::vec3& relativeLeftPos, const glm::vec3& relativeRightPos) {
...
void CameraActor::setHmdState(const bool renderHmd, ovrFovPort* fovport) {
...
void CameraActor::UpdateOrbitHmdVRSampleCode(const ovrPosef* eyeRenderPose) {
